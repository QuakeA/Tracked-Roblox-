...
body [class*="recommended"]:not([class*="recommended-item"]):not(a):not(.left-nav),
body [class*="Recommended"]:not([class*="Item"]):not(a):not(.left-nav),
...
html.tke-glass body:not(.tk-communities-page) [class*="recommended"]:not([class*="recommended-item"]):not(a):not(.left-nav),
html.tke-glass body:not(.tk-communities-page) [class*="Recommended"]:not([class*="Item"]):not(a):not(.left-nav),
