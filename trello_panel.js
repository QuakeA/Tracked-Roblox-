...
(function () {
  ...
  function injectStyles() {
    ...
    s.textContent = `
      ...
      #${PANE_ID} .tk-cover{width:100%;height:178px;background:rgba(0,0,0,.28);line-height:0;}
      #${PANE_ID} .tk-cover img{display:block;width:100%;height:100%;object-fit:cover;}
